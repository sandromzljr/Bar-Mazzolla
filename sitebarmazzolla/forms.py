...
class FormCriarPost(FlaskForm):
    titulo = StringField('Título da Conversa', validators=[DataRequired(), Length(2, 140)])
    corpo = TextAreaField('Texto da Conversa', validators=[DataRequired()])
    botao_submit = SubmitField('Conversar!')
